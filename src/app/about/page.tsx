        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-display font-bold text-navy mb-6">
              Meet the People Behind FloraTrace
            </h2>
            <p className="text-gray-dark text-lg mb-10 max-w-2xl mx-auto">
              Our leadership team and world-class advisory board bring decades
              of experience in forensic science, trade compliance, insurance,
              and global retail.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <CTAButton href="/about/team">
